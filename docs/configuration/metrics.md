...
| celeborn.metrics.master.clientMetrics.removedApp.retention | 120s | false | How long to retain removed application IDs in the client metrics source to reject late heartbeats after an application is lost. Entries older than this are periodically evicted. | 0.7.0 |  | 
